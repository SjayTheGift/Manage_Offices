...
const AddOfficePage = () => {
    const { loading, addOffice } = useContext(AppContext);
        ...
        <section className="w-full bg-gray-100 h-screen dark:bg-gray-900  px-8 xl:px-0">
            <div className="max-w-[1240px] mx-auto h-screen relative py-12">
                <div className='flex justify-between items-center mb-11'>
                    ...
                    <p className='text-center text-[18px] font-medium'>New Office</p>
                    <div></div>
                </div>
                <form className='flex flex-col gap-2' onSubmit={handleSubmit} >
                    ...
                    <button className='bg-btnPrimary text-white p-4 self-center w-[232px] rounded-full mb-4 text-[14px] md:text-[16px] mt-10' type='submit'>ADD OFFICE</button>
                </form>
            </div>
        </section>
    );
